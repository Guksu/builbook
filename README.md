...
- **작업실 헤더** — 본문/카드 전환, "패널" 메뉴(연표·현황·점검·검색·리서치·휴지통), 인스펙터, "더 보기"(미리보기·내보내기·테마), 집중 모드.
- **단축키** — Ctrl/⌘+Shift+1~7 패널 열고 닫기, Ctrl/⌘+P 빠른 열기, Alt+S 진행 상태 순환, Ctrl/⌘+F 찾기·바꾸기, F2 제목 편집. 에디터 툴바의 "?"에서 전체 목록.
